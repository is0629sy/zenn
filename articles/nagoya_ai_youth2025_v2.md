---
title: "【マルバツゲーム】【NAGOYA AI YOUTH CAMP 2025】AIでプログラミングを体験してみよう！"
emoji: "🤖"
...
今回はこの三つのファイルを使って、マルバツゲームを作っていきましょう！
...
1. `マルバツゲーム` フォルダが完成したら、そのフォルダをVSCodeで開きます
2. VSCodeを開き、左上の「ファイル」をクリックし、「フォルダーを開く…」をクリック
3. エクスプローラーやFinderが開いたら、その中から先ほど作成した `マルバツゲーム` を選択し、「開く」をクリックするとVSCodeでフォルダの中身を見ることができます
4. 次に、左側に出ている `マルバツゲーム` のファイル名の横にある `新しいファイル` をクリックし、 `index.html` と入力します
5. 同じ方法で `style.css` と `script.js` も作成します

## ChatGPTにマルバツゲームを作ってもらおう！ -HTML-

以下のプロンプトをChatGPTに入力し、HTMLのコードを出力してもらいましょう。

>index.html,style.css,script.jsを使ってマルバツゲームを作成してください。  
まずはhtmlだけを出力してください。
...
マルバツゲームのタイトルと、リスタートのボタンは表示されています。

ですが、マス目が表示されていないのでマルバツゲームっぽくないですね。

次にCSSを使って見た目を整えることでマス目が表示されてそれっぽくなります！

## ChatGPTにマルバツゲームを作ってもらおう！ -CSS-
...
これでマルバツゲームっぽいマス目はできましたが、まだマス目を押しても何も表示されません。  
いよいよ、JavaScriptを使ってマルバツゲームができるようにしていきましょう！

## ChatGPTにマルバツゲームを作ってもらおう！ -JavaScript-
...
たったこれだけの入力でマルバツゲームが完成しました！

# AIでWebアプリを作ってみよう 【応用編】

ここまでで、シンプルなマルバツゲームができましたね。

では次に、今まで内容をもとにマルバツゲームをカスタマイズしていきましょう！
